...
def actor_lifecycle_event(
    *,
    ...
    lifecycle_policy: str = "TRANSPORT_ONLY_V1",
    lifecycle_state_before: str | None = None,
    lifecycle_state_after: str | None = None,
    resource_cleanup_count: int = 0,
    reply_terminal_count: int = 0,
    ...
    return {
        ...
        "source_span": source_span(sequence),
        "actor_id": "actor-0",
        "actor_instance_id": "actor-instance-0",
        "receiver_id": "actor-0" if lifecycle_policy == "TRANSPORT_ONLY_V1" else None,
        "sender_id": "sender-0" if lifecycle_policy == "TRANSPORT_ONLY_V1" else None,
        "mailbox_id": "mailbox-0" if lifecycle_policy == "TRANSPORT_ONLY_V1" else None,
        "channel_id": "channel-0" if lifecycle_policy == "TRANSPORT_ONLY_V1" else None,
        "channel_sequence": channel_sequence,
        "mailbox_profile_id": "mailbox-profile-0" if lifecycle_policy == "TRANSPORT_ONLY_V1" else None,
        "state_region_id": "actor-state-region-0" if lifecycle_policy == "TRANSPORT_ONLY_V1" else None,
        "state_region_authority": state_region_authority,
        "turn_id": turn_id,
        "turn_index": turn_index,
        "handler_id": "handler-0" if turn_id is not None else None,
        "actor_protocol_binding_table_id": None,
        "actor_protocol_binding_id": None,
        "implementation_kind": None,
        "actor_handler_id": None,
        "actor_request_id": None,
        "responsibility_id": None,
        "binding_row_sha256": None,
        "supervisor_id": None,
        "root_owner_id": "actor-runtime-root-owner-0",
        ...
        "resource_cleanup_count": resource_cleanup_count,
        "reply_terminal_count": reply_terminal_count,
        "defect_id": defect_id,
        "suppressed_cleanup_defect_ids": [],
        "terminal_transport_failure": None,
        "correlation_id": None,
        "reply_id": None,
        "transfer_id": (
            transfer_id
            if transfer_id is not None
            else f"transfer-{message_id.rsplit('-', 1)[-1]}"
            if message_id is not None and lifecycle_policy == "TRANSPORT_ONLY_V1"
            else None
        ),
        "failure_id": None,
