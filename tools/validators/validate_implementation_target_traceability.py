...
def validate(root: Path, metadata: dict[str, Any], rows: list[dict[str, Any]]) -> list[str]:
    ...
    require(len(overlay_bindings) == 125, "OVERLAY_BINDING_EXACT_TOTAL_125")
    ...
    # R59-R64 are bounded pending-generation overlays. Make their exact E2 entries
    ...
    require(
        (direct, delegated, na, blocked) == (2461, 3, 503, 1254),
        "R64_EXACT_POST_OVERLAY_COUNTS",
    )
