...
def validate(root: Path, metadata: dict[str, Any], rows: list[dict[str, Any]]) -> list[str]:
    ...
    require(len(overlay_bindings) == 131, "OVERLAY_BINDING_EXACT_TOTAL_131")
    ...
    # R59-R69 are bounded pending-generation overlays. Make their exact E2 entries
    ...
    require(
        (direct, delegated, na, blocked) == (2467, 3, 501, 1250),
            "R69_EXACT_POST_OVERLAY_COUNTS",
    )
