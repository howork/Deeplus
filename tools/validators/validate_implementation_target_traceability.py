...
def validate(root: Path, metadata: dict[str, Any], rows: list[dict[str, Any]]) -> list[str]:
    ...
    require(len(overlay_bindings) == 133, "OVERLAY_BINDING_EXACT_TOTAL_133")
    ...
    # R59-R70 are bounded pending-generation overlays. Make their exact E2 entries
    ...
    require(
        (direct, delegated, na, blocked) == (2467, 4, 502, 1248),
            "R71_EXACT_POST_OVERLAY_COUNTS",
    )
