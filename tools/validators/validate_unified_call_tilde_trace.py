...
def validate(
    ...
    require(actor.get("lowering_row_successor_roles") == ["NORMAL", "DEFECT", "CANCELLATION"], "ACTOR_ROW_SUCCESSORS")
    ...
    require(hm_row.get("successor_roles") == ["NORMAL", "DEFECT", "CANCELLATION"], "HM010_SUCCESSORS")
    require(hm_row.get("terminator_plan", [{}])[0].get("successor_roles") == ["NORMAL", "DEFECT", "CANCELLATION"], "HM010_TERMINATOR_SUCCESSORS")
