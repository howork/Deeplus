...
INACTIVE_SEEDS = [
    "PATTERN_BORROWED_MATCH_CANNOT_MOVE_PAYLOAD",
...
def validate_documents(root: Path, docs: dict[str, Any]) -> tuple[list[dict[str, str]], list[str]]:
    ...
    check(errors, checks, dependency_core == [
        ...
        {"dependency_id": "CONTINUATION_INTERFACE", "status": "CANONICALLY_BOUND_DESIGN_STATIC", "panel": "continuation_rows", "required_digest_or_null": "0dc4891d1d23da397012f1ec1956ba1a3b52e884dbec604d27c8561a09941271"},
