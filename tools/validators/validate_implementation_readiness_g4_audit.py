...
def validate(root: Path) -> list[str]:
    ...
    expected_trace.update({"bound_direct": 3712, "not_applicable": 505})
    ...
    require(derived.get("bound_direct_cells") == 3712, "DERIVED_DIRECT")
    require(derived.get("bound_delegated_cells") == 4, "DERIVED_DELEGATED")
    require(derived.get("not_applicable_cells") == 505, "DERIVED_NA")
