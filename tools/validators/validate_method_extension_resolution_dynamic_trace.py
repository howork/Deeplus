...
R77_NON_TARGET_SHA256 = "a0895078a37f78707dcb352dfe61a5e0dc2e3d475fecc7c0803a33d8176a7e20"
...
def r75_successor_non_target_digest(
    ...
    """Fence every atomic cell except the exact R71-R75 targets."""
    excluded = {
        TARGET,
        R72_TARGET,
        R73_BOUNDARY_TARGET,
    ...
    *,
    ...
    if r72_successor or r73_successor or r74_successor or r75_successor or global_successor:
        ...
        successor_count, successor_digest = (
            r75_successor_non_target_digest(cells)
            if r75_successor
            else r74_successor_non_target_digest(cells)
            if r74_successor
