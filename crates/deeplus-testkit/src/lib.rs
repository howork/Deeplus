//! Deeplus responsibility-boundary scaffold: fixtures, mutation, differential, and receipt helpers.
//!
...
pub const RESPONSIBILITY: &str = "fixtures, mutation, differential, and receipt helpers";
...
pub struct DeeplusTestkitScaffold;
