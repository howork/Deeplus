//! Deeplus responsibility-boundary scaffold: tokenization, trivia, lexical modes, and recovery tokens.
//!
...
pub const RESPONSIBILITY: &str = "tokenization, trivia, lexical modes, and recovery tokens";
...
pub struct DeeplusLexerScaffold;
