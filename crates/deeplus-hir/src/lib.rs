//! Deeplus responsibility-boundary scaffold: contextual admission and normalized typed HIR.
//!
...
pub const RESPONSIBILITY: &str = "contextual admission and normalized typed HIR";
