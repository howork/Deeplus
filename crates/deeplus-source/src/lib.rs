//! Deeplus responsibility-boundary scaffold: source text, spans, source maps, and immutable source identity.
//!
...
pub const RESPONSIBILITY: &str = "source text, spans, source maps, and immutable source identity";
...
pub struct DeeplusSourceScaffold;
