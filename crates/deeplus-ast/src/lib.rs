//! Deeplus responsibility-boundary scaffold: typed AST facade over the lossless CST.
//!
...
pub const RESPONSIBILITY: &str = "typed AST facade over the lossless CST";
