//! Deeplus responsibility-boundary scaffold: stable diagnostic identity, rendering, ordering, and fix-its.
//!
...
pub const RESPONSIBILITY: &str = "stable diagnostic identity, rendering, ordering, and fix-its";
...
pub struct DeeplusDiagnosticsScaffold;
